...
def compute_skill(
    ...
    summary.setdefault("mean_market_roi_unweighted", summary.get("mean_roi"))
    ...
    risk_metrics = _risk_metrics(results)
    summary.setdefault("profit_factor", risk_metrics["profit_factor"])
    summary.setdefault("gross_profit", risk_metrics["gross_profit"])
    summary.setdefault("gross_loss", risk_metrics["gross_loss"])
    summary.setdefault("max_drawdown", 0.0)
    summary.setdefault("market_win_rate", 0.0)
    summary.setdefault("meaningful_market_win_rate", summary.get("market_win_rate", 0.0))
    summary.setdefault("low_value_winning_markets", 0)
    summary.setdefault("low_value_winning_markets_ratio", 0.0)
    summary.setdefault("low_value_wins_profit_share", 0.0)
    summary.setdefault("win_rate_quality_gap", 0.0)
    summary.setdefault("win_rate_padding_suspected", False)
    summary.setdefault("win_rate_padding_severity", "none")
    summary.setdefault("metric_gaming_flags", [])
    summary.setdefault("metric_gaming_flags_count", 0)
    summary.setdefault("small_bet_roi_padding_suspected", False)
    summary.setdefault("correlated_cluster_suspected", False)
    summary.setdefault("tail_risk_suspected", False)
    summary.setdefault("unrealized_pnl_dominance_suspected", False)
    summary.setdefault("reward_dependency_suspected", False)
    summary.setdefault("recent_performance_divergence_suspected", False)
